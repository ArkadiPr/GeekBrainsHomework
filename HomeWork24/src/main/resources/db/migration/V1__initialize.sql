...
('Harry Potter 1', 'Description 1', 300.0, 2000,'DETECTIVE'),
('Harry Potter 2', 'Description 2', 400.0, 2001,'FANTASY'),
('Harry Potter 3', 'Description 3', 500.0, 2002,'DETECTIVE'),
('Harry Potter 4', 'Description 4', 700.0, 2007,'FANTASTIC'),
...
('LOTR 2', 'Description 9', 900.0, 2004,'FANTASTIC'),
('LOTR 3', 'Description 10', 600.0, 2001,'FANTASY'),
('Hobbit', 'Description 11', 500.0, 2001,'FANTASTIC');